    ...
    public partial class Form1 : Form
    {
        ...
        private void btnKeres_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    pictureBox1.Image = new Bitmap($"Képek\\{Program.barlangs[ii].azon.ToString()}.jpg");

                    /*string a = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(a);
                    string b = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(b);
                    string c = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(c);
                    string d = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(d);
                    string eE = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(eE);
                    string f = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(f);
                    string g = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(g);
                    string h = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(h);
                    string i = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(i);
                    string j = "Képek\\" + Program.barlangs[ii].azon.ToString();
                    pictureBox1.Image = new Bitmap(j);*/
